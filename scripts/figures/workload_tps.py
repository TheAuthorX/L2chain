...
plt.text(x = 1 + 0.25, y = .1 * L2P[0], s = "{:.1f}k".format(L2P[0]/1000), ha='center', fontsize = bar_label_size)


for x in [2, 3]:
    plt.text(x = x - 0.39, y = 1.05 * QR[x-1], s = str(QR[x-1]), ha='center', fontsize = bar_label_size)
    plt.text(x = x - 0.23, y = 1.05 * CAP[x-1], s = str(CAP[x-1]), ha='center', fontsize = bar_label_size)
    plt.text(x = x - 0.07, y = 1.05 * L2R[x-1], s = str(L2R[x-1]), ha='center', fontsize = bar_label_size)
    plt.text(x = x + 0.09, y = 1.05 * QP[x-1], s = str(QP[x-1]), ha='center', fontsize = bar_label_size)
    plt.text(x = x + 0.25, y = 1.05 * L2P[x-1], s = str(L2P[x-1]), ha='center', fontsize = bar_label_size)
